...
class Mngapprovepengeluaran extends CI_Controller
{
    ...
    private function pagination()
    {
        ...
        $config['base_url'] = base_url('mngapprovepengeluaran/index/');
        $config['total_rows'] = $this->modelapp->getData('id_pengeluaran', 'tbl_pengeluaran', ["id_properti" => $_SESSION['id_properti'], 'status_manager ' => 'p'])->num_rows();
