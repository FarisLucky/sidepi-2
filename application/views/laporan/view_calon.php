    ...
    <div class="card">
      <div class="card-body p-4">
        ...
        <div class="row justify-content-end">
          <div class="col-sm-4">
            <div class="filter">
              <small class="text-danger ml-2">cari nama calon</small>
            </div>
            <form action="<?= base_url('laporancalon/index') ?>" method="post">
                ...
                <tbody>
                  ...
                  foreach ($calon as $value) { ?>
                    <tr>
                      ...
                      <td><?= $value['email'] ?></td>
                      <td>
                        <a href="<?= base_url('laporancalon/detail/' . $value['id_konsumen']) ?>" class="btn btn-icons btn-inverse-info"><i class="fa fa-info"></i></a><a href="<?= base_url() . " laporancalon/printcalon/" . $value['id_konsumen'] ?>" class="btn btn-icons btn-inverse-warning mx-2"><i class="fa fa-print"></i></a>
                      </td>
                    </tr>
                  <?php $no++;
                  } ?>
