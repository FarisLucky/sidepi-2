            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <a href="<?= base_url("transaksi") ?>" class="btn btn-dark float-right"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                </div>
              </div>
              <hr>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_spr" value="<?= set_value("txt_spr") ?>" placeholder="Masukkan SPR">
                  ...
                  <div class="form-group">
                    ...
                    <select name="select_konsumen" class="form-control select-opt p-2" id="select_konsumen">
                      ...
                      <?php foreach ($konsumen as $key => $value) : ?>
                        <option value=<?= $value->id_konsumen ?> <?= ($value->id_konsumen == set_value("select_konsumen") ? "selected" : "") ?>>
                  ...
                  <div class="form-group">
                    ...
                    <select name="select_unit" class="form-control select-opt p-2" id="select_unit">
                      ...
                      <?php foreach ($unit as $key => $value) : ?>
                        <option value="<?= $value->id_unit ?>" <?= ($value->id_unit == set_value("select_unit")) ? "selected" : ""; ?>><?= $value->nama_unit ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
              ...
              <div class="row justify-content-end">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="txt_kesepakatan" class="form-control" id="txt_kesepakatan" value="<?= set_value('txt_kesepakatan') ?>">
                  ...
                  <div class="form-group">
                    <div class="form-radio form-radio-flat">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input btn-check" name="radio_tj" id="radio2" value="tidak_masuk" checked>Tidak masuk harga jual
                      </label>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-radio form-radio-flat">
                      <label class="form-check-label">
                        <input type="radio" class="form-check-input btn-check" name="radio_tj" id="radio1" value="masuk">Masuk harga jual
                      </label>
                    </div>
                  </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control datepicker" name="tgl_tanda_jadi" id="tgl_tanda_jadi" value="<?= set_value("tgl_tanda_jadi") ?>">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control datepicker" name="tgl_uang_muka" id="tgl_uang_muka" value="<?= set_value("tgl_uang_muka") ?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="txt_type_pembayaran">Perkiraan Bayar Cicilan</label>
                    <input type="date" class="form-control datepicker" name="tgl_pembayaran" id="tgl_pembayaran" value="<?= set_value("tgl_pembayaran") ?>">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <button type="submit" class="btn btn-sm btn-success mr-2 simpan" disabled><i class="fa fa-save"></i>Simpan</button>
