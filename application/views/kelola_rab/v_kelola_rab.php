      ...
      <div class="card-body p-4">
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" value="<?php echo number_format($rab_properti["total_anggaran"], 2, ",", ".") ?> " class="form-control" id="exampleInputName1" disabled>
              </div>
            </div>
          </div>
          <div class="col-sm-12 button">
            ...
            <?php } ?>
            <a href="<?= base_url("rab/printrab/" . $rab_properti["id_rab"]) ?>" class="btn btn-warning"><i class="fa fa-print"></i> Print</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm-12">
            ...
            <a href="<?= base_url() ?>rab/tambah/<?= $rab_properti["id_rab"] ?>" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus"></i>Tambah</a>
          </div>
        </div>
        <hr>
        <div class="row">
                ...
                <tbody>
                  ...
                  foreach ($kelola_rab as $k) { ?>
                    <tr>
                      ...
                      <td><a href="<?= base_url() . 'rab/edit/' . $k->id_detail ?>" class="btn btn-icons btn-inverse-info mx-2"><i class="fa fa-edit"></i></a><button type="button" class="btn btn-icons btn-inverse-danger" onclick="deleteItem('<?= base_url('rab/hapus/' . $k->id_detail) ?>')"><i class="fa fa-trash"></i></a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
